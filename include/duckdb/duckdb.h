...
*/
DUCKDB_API const char *duckdb_library_version(void);
...
*/
DUCKDB_API size_t duckdb_config_count(void);
...
*/
DUCKDB_API idx_t duckdb_vector_size(void);
...
*/
DUCKDB_API duckdb_table_function duckdb_create_table_function(void);
